...
class ProcessDeliveryOrders {
	...
	public static DeliveryOrder findFirstOrder(List<DeliveryOrder> deliveryOrder) {
		return deliveryOrder.stream()
				.min(Comparator.comparing(DeliveryOrder::getDeliveryDate))
