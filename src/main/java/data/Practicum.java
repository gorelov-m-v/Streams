...
public class Practicum {
    ...
    public static void main(String[] args){
        ...
        Instant startOfYearMoment = Instant.ofEpochSecond(startOfYear).plus(userTimezone, HOURS);

        // и текущую дату
        Instant thisMoment = Instant.now();

        // и конечную дату нашего графика рассветов и закатов (плюс семь дней)
        Instant lastMoment = thisMoment.plus(7, DAYS);;
        ...
        do {
            ...
            thisMoment = thisMoment.plus(1, DAYS);
