...
class Practicum {
    public static void main(String[] args) {
        ...
        System.out.println("В прошлый раз задача была начата в " + LocalTime.parse(taskStart.format(formatter)) + ",");
        // taskFinish должен быть выведен в указанном формате
        System.out.println("а закончена в " + LocalTime.parse(taskFinish.format(formatter)) + ".");
