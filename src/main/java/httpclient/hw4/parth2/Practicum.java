    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                double rateEUR = jsonObject.getAsJsonObject("rates").get("EUR").getAsDouble();
                double rateUSD = jsonObject.getAsJsonObject("rates").get("USD").getAsDouble();
