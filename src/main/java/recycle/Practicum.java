...
public class Practicum {
	...
	public static void main(String[] args) {
		...
		if (commandValue.equals(ChatCommand.MAP.toString())) {
			System.out.println(MAP_LINK);
		} else if (commandValue.equals(ChatCommand.RECYCLABILITY.toString())) {
			System.out.println("Введите код переработки:");
			int code = scanner.nextInt();
			isRecycled(code);
		} else if (commandValue.equals(ChatCommand.BONUS.toString())) {
			...
			System.out.println("Количество бонусных баллов: " + caf * mass + ".");
		}
	}
